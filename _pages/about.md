...
# Preprints
* Adaptive Off-Policy Inference for M-Estimators Under Model Misspecification (with Robin Dunn and Aaditya Ramdas), 2025. Submitted at <em>Operations Research</em>. ([arxiv](https://arxiv.org/abs/2509.14218)) ([slides](https://jamesleiner.github.io/files/Adaptive/presentation.pdf)) ([code](https://github.com/jamesleiner/Adaptive-M-Estimation))
